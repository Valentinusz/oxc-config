...
export const typescriptStyle = {
  rules: {
    ...
    // 🏆 Best practice. Array literal is preferred.
    ...
    // 🏆 Best practice. Mixing readonly fields and trivial literal getters for the same kind of value makes class
    // APIs inconsistent and harder to scan.
    ...
    // 🏆 Best practice. Inconsistent usage of generic constructors can make the code harder to read and maintain.
    ...
    // ⛓️ Too restrictive. Sometimes index signature is needed for complex types.

    // ✅ typescript/consistent-type-assertions
    // Enforce consistent usage of TypeScript type assertions.
    // 🏆 Best practice. `as` is preferred over angle bracket syntax.
    'typescript/consistent-type-assertions': ['error'],

    // ❌ typescript/consistent-type-definitions
    // Enforce type definitions to consistently use either `interface` or `type`.
    // ⛓️ Too restrictive. Sometimes using `type` is preferred.

    // ✅ typescript/consistent-type-exports
    // 💭 Type aware.
    // Enforce using export type for exports that are only used as types.
    // 🏆 Best practice. Mixing type-only exports with value exports without export type makes module intent harder to
    // read and can cause unnecessary runtime export surface.
    'typescript/consistent-type-exports': 'error',

    // ✅ typescript/consistent-type-imports
    // Enforce consistent usage of type imports by adding or removing the type keyword from imports.
    // 🏆 Best practice. Inconsistent usage of type imports can make the code harder to read and understand.
    'typescript/consistent-type-imports': 'error',

    // ✅ typescript/dot-notation
    // Enforce dot notation whenever property access can be written safely as obj.prop.
    // 🏆 Best practice. Dot notation is generally more readable and concise than bracket notation for static property
    // names.
    'typescript/dot-notation': 'error',

    // ✅ typescript/method-signature-style
    // Enforce using a particular method signature syntax.
    // 🏆 Best practice. Property syntax is preferred in TypeScript.
    'typescript/method-signature-style': ['error', 'property'],

    // ✅ typescript/no-empty-interface
    // Disallow the declaration of empty interfaces.
    // 🐛 Bug prevention. Using an empty interface is often a sign of programmer error.
    'typescript/no-empty-interface': 'error',

    // ✅ typescript/no-inferrable-types
    // Disallow explicit type declarations for variables or parameters initialized to a `number`, `string`, or
    // `boolean`.
    // 🏆 Best practice. Explicitly typing variables or parameters that are initialized to a literal value is
    // unnecessary because TypeScript can infer the type from the value.
    'typescript/no-inferrable-types': 'error',

    // ❌ typescript/no-unnecessary-qualifier
    // 💭 Type aware.
    // Disallow namespace qualifiers when the referenced name is already in scope.
    // ➡️ Handled by typescript/no-namespace.
    ...
    // 🏆 Best practice. Better performance and shows intent better.
    ...
    // 🏆 Best practice. The function type form is generally preferred when possible for being more succinct and
    // readable.
    ...
    // 🏆 Best practice. Members that never change should be declared readonly to make class invariants explicit and
