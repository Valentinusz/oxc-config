...
export const unicornPedantic = {
  rules: {
    ...
    // 🐛 Bug prevention. You should instead destructure and specify default values per field.
    'unicorn/no-object-as-default-parameter': 'error',

    // ❌ unicorn/no-static-only-class
    // Disallow class declarations that exclusively contain static members.
    // ➡️ Handled by typescript/no-extraneous-class.
    ...
    // 🏆 Best practice. Better to compare against undefined directly.
