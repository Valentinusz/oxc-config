...
export const unicornRestriction = {
  rules: {
    ...
    // ➡️ Handled by import/no-default-export.

    // ✅ unicorn/no-array-for-each
    // Forbids the use of Array#forEach in favor of a for loop.
    // 🏆 Best practice. For-of is better.
    ...
    // ➡️ Handled by many rules that already disable CommonJS features.
