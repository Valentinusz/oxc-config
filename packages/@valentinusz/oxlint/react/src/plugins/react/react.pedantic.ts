...
export const reactPedantic = {
  rules: {
    ...
    // 🔒 Security. Using `target='_blank'` without `rel='noreferrer'` is a security vulnerability.
    ...
    // This rule prevents characters that you may have meant as JSX escape characters from being accidentally injected
    // as a text node in JSX statements.
    // 🐛 Bug prevention.
    'react/no-unescaped-entities': 'error',

    // ✅ react/rules-of-hooks
    // Enforces the Rules of Hooks, ensuring that React Hooks are only called in valid contexts and in the correct
    // order.
    // 🐛 Bug prevention.
